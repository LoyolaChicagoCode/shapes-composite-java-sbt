...
public class TestBoundingBox {
	...
	public void testGroupComplex() {
		Shape s = new Location(50, 100, new Fill(new Group(new Circle(20),
				new Location(150, 50, new Stroke(Color.RED, new Group(
						new Rectangle(50, 30), new Rectangle(300, 60),
						new Location(100, 200, new Stroke(Color.ORANGE,
								new Fill(new Circle(50))))))), new Rectangle(
						100, 200))));
		Location b = s.getBoundingBox();
		Rectangle r = (Rectangle) b.getShape();
